...
class ContactsExcelParser(ExcelParser):
    ...
    def _load_cell(
        self, row: tuple, key: int, row_number: int, can_be_null: bool = True
    ) -> str:
        """
    ...
    def _contacts_parser(
        ...
        for row in contacts_sheet.iter_rows(
            ...
            if (
                row[headers_dict["buyer_key"]] is None
                or row[headers_dict["buyer_full_name"]] == ""
            ):
                continue
